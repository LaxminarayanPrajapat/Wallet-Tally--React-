...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] flex flex-col font-body">
      <header className="w-full bg-gradient-to-r from-primary to-accent text-white shadow-xl sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              <Link href="/admin/dashboard" className="flex items-center gap-2 group">
                ...
                <span className="font-bold text-lg tracking-tight whitespace-nowrap">Wallet Tally Admin</span>
              </Link>
              ...
              <nav className="hidden lg:flex items-center gap-1">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className={cn(
                      "flex items-center gap-2 px-3 py-2 transition-all text-sm font-medium rounded-lg outline-none",
            ...
            <div className="flex items-center gap-3">
              <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                ...
                <SheetContent side="left" className="p-0 border-0 w-72 bg-gradient-to-b from-primary to-accent text-white">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors focus:outline-none">
                    <ShieldCheck className="w-5 h-5 text-white" />
                    <span className="text-sm font-medium text-white whitespace-nowrap hidden sm:inline">WalletTallyAdmin</span>
      ...
      <main className="flex-1 w-full px-4 md:px-8 py-8 max-w-[1600px] mx-auto">
        {children}
      </main>

      <footer className="w-full bg-gradient-to-r from-primary to-accent text-white py-6 mt-auto">
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm">Wallet Tally Admin Panel</span>
            </div>
            <div className="text-center">
              <p className="text-xs font-medium opacity-90">© 2024 Wallet Tally. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>

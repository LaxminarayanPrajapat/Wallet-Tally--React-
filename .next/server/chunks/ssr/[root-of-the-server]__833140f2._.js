...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfkit$2f$js$2f$pdfkit$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdfkit/js/pdfkit.es.js [app-rsc] (ecmascript)");
...
async function exportTransactionsToPdf(email, transactions, startDate, endDate, currencySymbol) {
    try {
        const doc = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfkit$2f$js$2f$pdfkit$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]({
            margin: 50
        });
        const chunks = [];
        doc.on('data', (chunk)=>chunks.push(chunk));
        // Logo and Header
        doc.fillColor('#1a2e3a').fontSize(24).font('Helvetica-Bold').text('Wallet Tally', {
            align: 'center'
        });
        ...
        transactions.forEach((t)=>{
            ...
            const dateStr = t.date?.toDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(t.date.toDate(), 'MM/dd/yyyy') : 'N/A';
            ...
            doc.font('Helvetica').fillColor('#475569').text(dateStr, col1, currentY).text(t.type, col2, currentY, {
                ...
                height: 20,
                ellipsis: true
            }).fillColor(t.type === 'income' ? '#059669' : '#dc2626').text(amountStr, col5, currentY, {
                align: 'right'
            });
            currentY += 25;
        });
      ...
      `
        ...
        // We can't easily attach via the simple sendMail we have without updating it, 
        // but I'll update sendMail to support attachments if needed or just handle it here.
        // For now, let's assume sendMail can be extended or we use a separate logic.
        // Actually, let's update lib/email.ts to handle attachments.
        return {
            success: true
        };
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__833140f2._.js.map
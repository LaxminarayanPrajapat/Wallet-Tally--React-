...
/* __next_internal_action_entry_do_not_use__ [{"6079f589103979d365399e4b578cebf13a40f59fc0":"sendFeedbackApprovalEmail","60ce387093c6630fb18f57fd4c30be3a8ca7eb44b1":"sendOtpEmail","700253dc96c086132ec7b7207b46a1ea94a7464dfe":"sendUserWarningEmail","705e2233038eb16bd2ec17cc557098372ff6aae7f0":"sendFeedbackDeletionEmail"},"",""] */ __turbopack_context__.s([
...
async function sendFeedbackApprovalEmail(email, userName) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendMail"])({
            to: email,
            subject: 'Your feedback has been featured on Wallet Tally!',
        ...
        <div style="font-family: sans-serif; color: #1a2e3a; padding: 40px; border: 1px solid #e2e8f0; border-radius: 24px; max-width: 600px; margin: 0 auto;">
          ...
          <p>We truly appreciate the time you took to share your experience. Your story helps others understand the value of smart financial tracking.</p>
          <div style="background: #f0fdf4; padding: 20px; border-radius: 12px; margin: 24px 0; border: 1px solid #dcfce7;">
            <p style="margin: 0; font-weight: bold; color: #166534;">"Your words are now helping our community grow!"</p>
          </div>
...
async function sendFeedbackDeletionEmail(email, userName, reason) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendMail"])({
            to: email,
            subject: 'Update regarding your feedback on Wallet Tally',
        ...
        <div style="font-family: sans-serif; color: #1a2e3a; padding: 40px; border: 1px solid #e2e8f0; border-radius: 24px; max-width: 600px; margin: 0 auto;">
          ...
          <p>Hi ${userName},</p>
          <p>We are writing to inform you that your recently submitted feedback has been removed from our system by our moderation team.</p>
          ...
          <p>We encourage honest feedback but require it to follow our community guidelines. If you have questions, please contact our support team.</p>
          <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 32px 0;" />
...
async function sendUserWarningEmail(email, userName, violationType) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendMail"])({
            to: email,
            subject: 'Important: Official Account Warning - Wallet Tally',
        ...
        <div style="font-family: sans-serif; color: #1a2e3a; padding: 40px; border: 1px solid #e2e8f0; border-radius: 24px; max-width: 600px; margin: 0 auto;">
          <div style="text-align: center; margin-bottom: 24px;">
            <h1 style="color: #f59e0b; margin: 0; font-size: 24px;">⚠️ Account Warning</h1>
          </div>
          <p>Hi <strong>${userName}</strong>,</p>
          <p>We are reaching out because our administrative team has identified activity on your account that violates our platform policies.</p>
          <div style="background: #fffbeb; padding: 24px; border-radius: 16px; margin: 24px 0; border: 1px solid #fef3c7;">
            <p style="margin: 0; font-weight: bold; color: #92400e; text-transform: uppercase; font-size: 12px; letter-spacing: 1px;">Violation Type:</p>
            <p style="margin: 8px 0 0 0; color: #b45309; font-size: 18px; font-weight: bold;">${violationType}</p>
          </div>
          <p>Please review our Terms of Service to ensure your future activity remains in compliance. Continued violations may lead to temporary suspension or permanent removal of your account.</p>
          <p style="color: #64748b; font-size: 14px; line-height: 1.6;">If you believe this warning was issued in error, please reply to this email to speak with our support staff.</p>
          <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 32px 0;" />
          <p style="font-size: 11px; color: #94a3b8; text-align: center; font-weight: bold;">OFFICIAL NOTICE FROM WALLET TALLY ADMINISTRATION</p>
        </div>
      `
        });
        return {
...
__turbopack_context__.s([
    "700253dc96c086132ec7b7207b46a1ea94a7464dfe",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9aa824f9._.js.map
...
function RegisterPage() {
    ...
    const onSubmit = async (values)=>{
        ...
        // 2. Create user, send verification, create profile
        try {
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(auth, values.email, values.password);
            ...
            const country = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$countries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countries"].find((c)=>c.code === values.country);
            if (country) {
                localStorage.setItem('currencySymbol', country.currency.symbol);
            }
            toast({
            ...
            router.push("/verify-email?email=".concat(encodeURIComponent(values.email)));
        } catch (error) {
...
_s(RegisterPage, "t7dX0pEEPq3dteAVrZacS7REneI=", false, function() {
    return [
...
//# sourceMappingURL=src_a71e60a5._.js.map